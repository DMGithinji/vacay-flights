                                        ...
                                        <div className="card-body">
                                            <Row>
                                                ...
                                                <Col md={6} className = "pt-4">
                                                    <div className="form-group fill">
                                                        <label htmlFor="billing-address">Passport or ID Number</label>
                                                        <input className="form-control" type="text" placeholder="Passport or ID Number" id="billing-address"/>
                                                    </div>
                                                </Col>
                                                <Col md={6} className = "pt-4">
                                                    <div className="form-group fill">
                                                        <label htmlFor="billing-town-city">Date of Expiry</label>
                                            ...
                                            <Col md={3}>
                                                ...
                                                <Col md={6} className = "pt-4">
                                                    <div className="form-group fill">
                                                        <label htmlFor="Date of Birth"><span className="text-danger">*</span> Phone </label>
                                                        <input className="form-control" type="text" placeholder="dd/mm/yyyy" id="date-of-birth" />
                                                    </div>
                                                </Col>
                                                <Col md={6} className = "pt-4">
                                                    <div className="form-group fill">
                                                        <label htmlFor="Date of Birth"><span className="text-danger">*</span> Email </label>
                                                        <input className="form-control" type="text" placeholder="dd/mm/yyyy" id="date-of-birth" />
                                                    </div>
                                                </Col>
